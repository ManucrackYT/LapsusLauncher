...
}                             = require('lapsus-core/mojang')
const {
    RestResponseStatus,
    isDisplayableError,
    validateLocalFile
}                             = require('lapsus-core/common')
const {
    FullRepair,
...
async function asyncSystemScan(effectiveJavaOptions, launchAfter = true){
    ...
    if(jvmDetails == null) {
        ...
        setOverlayContent(
            ...
            `In order to join this, you need a 64-bit installation of Java ${effectiveJavaOptions.suggestedMajor}. Would you like us to install a copy?`,
            'Install Java',
            'Install Manually'
        )
        setOverlayHandler(() => {
...
async function dlAsync(login = true) {
    ...
    try {
        ...
        loggerLaunchSuite.error('Unable to refresh Minecraft versions.', err)
        showLaunchFailure('Fatal Error', 'Could not load the distribution index. Contact support for help.')
        return
    }
    ...
    if(login) {
        ...
        const gameStateChange = function(data){
            ...
            if(SERVER_JOINED_REGEX.test(data)){
                ...
                DiscordWrapper.updateDetails('Sailing to the server!')
            }
        }
        ...
        const gameErrorListener = function(data){
            ...
            if(data.indexOf('Could not find or load main class net.minecraft.launchwrapper.Launch') > -1){
                ...
                showLaunchFailure('Error During Launch', 'The main file, LaunchWrapper, failed to download properly. As a result, the game cannot launch.<br><br>To fix this issue, temporarily turn off your antivirus software and launch the game again.<br><br>If you have time, please <a href="https://github.com/ManucrackYT/LapsusLauncher/issues">submit an issue</a> and let us know what antivirus software you use. We\'ll contact them and try to straighten things out.')
            }
        }
        ...
        try {
            ...
            setLaunchDetails('Done. Enjoy the experience!')
