...
ipcMain.on('step3Action', (event, arg) => {
    if (arg === 'doSomething') {
        console.log('Step 3: Performing custom action');
        event.sender.send('step3Response', { success: true, message: 'Action completed!' });
    } else {
        event.sender.send('step3Response', { success: false, message: 'Unknown action' });
    }
});
